...
class BuburBeras extends StatefulWidget {
  const BuburBeras({super.key});

  @override
  State<BuburBeras> createState() => _BuburBerasState();
}

class _BuburBerasState extends State<BuburBeras> {
  @override
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(
                          "Kandungan Gizi Pada Bubur Beras",
