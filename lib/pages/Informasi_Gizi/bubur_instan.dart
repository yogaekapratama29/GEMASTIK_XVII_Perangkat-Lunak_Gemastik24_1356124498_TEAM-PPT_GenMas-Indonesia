...
class BuburInstan extends StatefulWidget {
  const BuburInstan({super.key});

  @override
  State<BuburInstan> createState() => _BuburInstanState();
}

class _BuburInstanState extends State<BuburInstan> {
  @override
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(
                          "Kandungan Gizi Pada Bubur Instan",
